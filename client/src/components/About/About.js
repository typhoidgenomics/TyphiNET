    ...
    <Card className={classes.card} elevation={2}>
      <CardContent className={classes.cardContent}>
        ...
        <div className={classes.paragraph}>
          ...
          mutant (<i>gyrA</i>-83 and <i>gyrA</i>-87, together with either <i>parC</i>-80 or <i>parC</i>-84), or plasmid-mediated 
          quinolone resistance (PMQR) together with <i>gyrA</i>-83, <i>gyrA</i>-87 and/or <i>gyrB</i>-464. Third-generation 
          cephalosporin resistance (3GCR): presence of an extended-spectrum beta-lactamase(ESBL) (<i>bla</i>CTX-M-12, 
          <i>bla</i>CTX-M-15, <i>bla</i>CTX-M-23, <i>bla</i>CTX-M-55,{' '} <i>bla</i>SHV-12) or <i>ampC</i> gene.
          Extreme drug resistance (XDR): MDR plus CipR plus 3GCR. Azithromycin resistance (AziR): mutation at <i>acrB</i>-717. 
          See{' '}
        ...
        <div className={classes.paragraph}>
          ...
          {' '}as described in{' '}
          < a href="https://www.medrxiv.org/content/10.1101/2022.12.28.22283969v1" target="_blank" rel="noreferrer">
          	this paper
          </a>
          . The database can be downloaded using the button above.
          <p>
