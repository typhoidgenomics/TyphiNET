...
const DashboardPage = () => {
        ...
        const tooltip = (positionY, width1, width2, sort, wrapperS, stroke, chart = -1) => {
            return ( <
                Tooltip position = {
                    { y: positionY, x: dimensions.width < mobile ? -20 : 0 } }
                    ...
                    ({ active, payload, label }) => {
                        if (payload !== null) {
                            ...
                            if (active) {
                                return ( <
                                    div style = {
                                        { backgroundColor: "rgba(255,255,255,1)", border: "solid rgba(0,0,0,0.25) 1px", padding: 16, display: "flex", flexDirection: "column" } } >
                                    <
                                    span style = {
                                        { fontFamily: "Montserrat", fontWeight: 600, fontSize: 24 } } > { label } < /span> <
                                    div style = {
                                        { height: 14 } }
                                    /> <
                                    div style = {
                                        { display: "flex", flexWrap: "wrap", width: width1, flexDirection: "" } } > {
                                        payload.reverse().map((item, index) => {
                                            ...
                                            return ( <
                                                div key = { index + item }
                                                style = {
                                                    { display: "flex", flexDirection: "row", alignItems: "center", width: width2, marginBottom: 8 } } >
                                                <
                                                div style = {
                                                    { backgroundColor: stroke ? item.stroke : item.fill, height: 18, width: 18, border: "solid rgb(0,0,0,0.75) 0.5px", flex: "none" } }
                                                /> <
                                                div style = {
                                                    { display: "flex", flexDirection: "column", marginLeft: 8, width: "95%" } } >
                                                <
                                                span style = {
                                                    { fontFamily: "Montserrat", color: "rgba(0,0,0,0.75)", fontWeight: 500, fontSize: 14, wordWrap: 'break-word', width: dimensions.width < mobile ? '80%' : '100%' } } > { item.name } < /span> <
                                                span style = {
                                                    { fontFamily: "Montserrat", color: "rgba(0,0,0,0.75)", fontSize: 12 } } > N = { item.value } < /span> <
                                                span style = {
                                                    { fontFamily: "Montserrat", color: "rgba(0,0,0,0.75)", fontSize: 10 } } > { percentage } % < /span> <
                                                /div> <
                                                /div>
                                            )
                                        })
                ...
                if (populationStructureFilter === 1) { /* Genotype */
                    ...
                    return ( <
                            ...
                            { tooltip(300, dimensions.width < 620 ? 250 : 530, dimensions.width > 620 ? "20%" : "50%", false, { zIndex: 100, top: 20, right: -20 }, false) } {
                                genotypes.map((item) => < Bar dataKey = { item }
                                    stackId = "a"
                                ...
                                const armClassFilterComponent = (info) => {
                                    ...
                                    return ( <
                                        ...
                                        type = { "category" }
                                        interval = { dimensions.width < middle ? 1 : 0 }
                                        tick = {
                                            { fontSize: 14 } }
                                        /> <
                                        YAxis domain = {
                                ...
                                const plotAmrClassChart = () => {
                                    switch (amrClassFilter) {
                                        ...
                                        case 'AMR Profiles':
                                            return (armClassFilterComponent({
                                                left: dimensions.width > desktop ? 12 : -30,
                                                fontsize: dimensions.width > desktop ? 14 : 5,
                                                strokeWidth: 0.5,
                                                width: 3,
                                                bars: [
                                                ...
                                                if (payload !== null) {
                                                    if (active) {
                                                        return ( <
                                                            ...
                                                            /> <
                                                            div style = {
                                                                { display: "flex", flexWrap: "wrap", justifyContent: "space-between", width: 250 } } > {
                                                                payload.reverse().map((item, index) => {
                                                                    ...
                                                                    return ( <
                                                                        div key = { index }
                                                                        style = {
                                                                            { display: "flex", flexDirection: "row", alignItems: "center", width: "33.33%", marginBottom: 8 } } >
                                                                        <
                                                                        div style = {
                                                                            { backgroundColor: item.fill, height: 18, width: 18, border: "solid rgb(0,0,0,0.75) 0.5px", flex: "none" } }
                                                                        /> <
                                                                        div style = {
                                                                            { display: "flex", flexDirection: "column", marginLeft: 8, wordWrap: "break-word", overflowX: "hidden" } } >
                                                                        <
                                                                        span style = {
                                                                            { fontFamily: "Montserrat", color: "rgba(0,0,0,0.75)", fontWeight: 500, fontSize: 14 } } > { item.name } < /span> <
                                                                        span style = {
                                                                            { fontFamily: "Montserrat", color: "rgba(0,0,0,0.75)", fontSize: 12 } } > N = { item.value } < /span> <
                                                                        span style = {
                                                                            { fontFamily: "Montserrat", color: "rgba(0,0,0,0.75)", fontSize: 10 } } > { percentage } % < /span> <
                                ...
                                const plotDrugTrendsChart = () => {
                                    return ( <
                                        ...
                                        Legend content = {
                                            (props) => {
                                                ...
                                                return ( <
                                                    ...
                                                    <
                                                    div style = {
                                                        { display: "flex", flexDirection: "row", flexWrap: "wrap", width: dimensions.width < mobile ? "93%" : "95%", justifyContent: "space-between", marginTop: 10 } } > {
                                                        payload.map((entry, index) => {
                                                            const { dataKey, color } = entry
                                                            return ( <
                                                                div key = { index }
                                                                style = {
                                                                    { display: "flex", flexDirection: "row", alignItems: "start", width: 120, marginBottom: 4, marginLeft: 3, marginRight: 3 } } >
                                                                <
                                                                div style = {
                                                                    { height: 8, width: 8, borderRadius: 4, marginTop: 3, backgroundColor: color, flexShrink: 0 } }
                                                                /> <
                                                                span style = {
                                                                    { fontSize: 12, paddingLeft: 4 } } > { dataKey } < /span> <
                                                                /div>
                                                            )
                                                        })
                                                    } <
                                        ...
                                        /> { tooltip(150, dimensions.width < mobile ? 250 : 325, "50%", true, { zIndex: 100, top: 175, right: 0 }, true, 1) } { amrClassesForFilter.slice(1).map((item) => ( < Line dataKey = { item }
                                ...
                                const plotDrugsAndGenotypesChart = () => {
                                        return ( <
                                                ...
                                                /> { tooltip(150, dimensions.width < mobile ? 250 : 325, "50%", false, { zIndex: 100, top: 160 }, false, 0) } {
                                                    amrClassesForFilter.slice(1).map((item) => ( < Bar dataKey = { item }
                                                    ...
                                                    const getPopulationStructureChartLabel = () => {
                                                        if (populationStructureFilter === 1)
                                                            return <span className = "y-axis-label-vertical"
                                                        style = {
                                                            { marginRight: 8 } } > Number of genomes < /span>
                                                        else
                                                    ...
                                                    const generateMapLegendOptions = () => {
                                                        ...
                                                        switch (mapView) {
                                                                ...
                                                                return ( <
                                                                    ...
                                                                    /div> {
                                                                        [...Array(6).keys()].map((n) => {
                                                                            ...
                                                                            return ( <
                                                                                div key = { n }
                                                                                className = "samples-info" >
                                                                                <
                                                                                div className = "color"
                                                                                style = {
                                                                                    { backgroundColor: mapSamplesColorScale(samplesLegend) } }
                                                                                /> <
                                                            ...
                                                            case 'AMR Profiles':
                                                                ...
                                                                return ( <
                                                                    div style = {
                                                                        { maxHeight: 300, display: "flex", flexDirection: "column", overflowY: "scroll" } } > {
                                                                        amrProfiles.map((a, n) => {
                                                                            return ( <
                                                                                div key = { n }
                                                                                className = "samples-info" >
                                                                                ...
                                                                                div className = "color"
                                                                                style = {
                                                                                    { backgroundColor: getColorForAMR(a) } }
                                                                                /> <
                                                                                span > { a } < /span> <
                                                                                /div>
                                                                            )
                                                                    ...
                                                                    div style = {
                                                                        ...
                                                                        genotypes.map((g, n) => {
                                                                            return ( <
                                                                                ...
                                                                                div className = "color"
                                                                                style = {
                                                                                    { backgroundColor: getColorForGenotype(g) } }
                                                                                /> <
                                                                                span > { g } < /span> <
                                                                                /div>
                                                                            )
                                                                    ...
                                                                    /div> {
                                                                        percentageSteps.map((g, n) => {
                                                                            return ( <
                                                                                ...
                                                                                div className = "color"
                                                                                style = {
                                                                                    { backgroundColor: mapRedColorScale(g) } }
                                                                                /> <
                                                                                span > { g } % < /span> <
                                                                                /div>
                                                                            )
                                                                    ...
                                                                    /div> {
                                                                        percentageSteps.map((n) => {
                                                                            return ( <
                                                                                ...
                                                                                div className = "color"
                                                                                style = {
                                                                                    { backgroundColor: mapRedColorScale(n) } }
                                                                                /> <
                                                                                span > { n } % < /span> <
                                                                                /div>
                                                                            )
                                                                    ...
                                                                    div style = {
                                                                        ...
                                                                        drugs.map((d, n) => {
                                                                            return ( <
                                                                                ...
                                                                                div className = "color"
                                                                                style = {
                                                                                    { backgroundColor: getColorForDrug(d) } }
                                                                                /> <
                                                                                span > { d } < /span> <
                                                                                /div>
                                                                            )
                                                                    ...
                                                                    div style = {
                                                                        ...
                                                                        incTypes.map((d, n) => {
                                                                            return ( <
                                                                                ...
                                                                                div className = "color"
                                                                                style = {
                                                                                    { backgroundColor: getColorForIncType(d) } }
                                                                                /> <
                                                                                span > { d } < /span> <
                                                                                /div>
                                                                            )
                                                    ...
                                                    const renderMapLegend = () => {
                                                        return ( <
                                                            ...
                                                            <
                                                            InputLabel style = {
                                                                { fontWeight: 500, fontFamily: "Montserrat", whiteSpace: "nowrap" } } > Select map view < /InputLabel> <
                                                            Select value = { mapView }
                                                            onChange = { evt => setMapView(evt.target.value) }
                                                            fullWidth style = {
                                                                { fontWeight: 600, fontFamily: "Montserrat", fontSize: 14 } } >
                                                            <
                                                            MenuItem style = {
                                                                { fontWeight: 600, fontFamily: "Montserrat", fontSize: 14 } }
                                                            value = { 'Dominant Genotype' } >
                                                            Dominant Genotype <
                                                            /MenuItem> <
                                                            MenuItem style = {
                                                                { fontWeight: 600, fontFamily: "Montserrat", fontSize: 14 } }
                                                            ...
                                                            /Select> <
                                                            /FormControl> { generateMapLegendOptions() } <
                                                            /div>
                                                        )
                                                    }
                                                    ...
                                                    return ( <
                                                            ...
                                                            <
                                                            img className = "logoImageMenu-mobile"
                                                            src = { typhinetLogoImg }
                                                            alt = "TyphiNET" / >
                                                            <
                                                            /div> <
                                                            div style = {
                                                                { padding: dimensions.width > 770 ? '16px' : '16px 0px' } } >
                                                            <
                                                            ...
                                                            span > Total Genomes < /span> {
                                                                totalGenomes.length === actualGenomes.length ? ( <
                                                                    ...
                                                                    span className = "value" > { actualGenomes.length } <
                                                            ...
                                                            className = "icon-info"
                                                            title = "Total genotypes present in TyphiNET database / Total genotypes worldwide published" / >
                                                            <
                                                            /span> {
                                                                totalGenotypes.length === actualGenotypes.length ? ( <
                                                                    span className = "value" > { totalGenotypes.length } < /span>
                                                                ) : ( <
                                                                    span className = "value" > { actualGenotypes.length } <
                                                            ...
                                                            <
                                                            h2 style = {
                                                                { textAlign: "center" } } > Global Overview of Salmonella Typhi < /h2> <
                                                            div className = "map-filters-wrapper-inside"
                                                            style = {
                                                                { flexDirection: dimensions.width > desktop ? 'row' : 'column' } } >
                                                            <
                                                            div className = "map-wrapper" >
                                                            <
                                                            ComposableMap id = "control-map"
                                                            data - tip = ""
                                                            projectionConfig = {
                                                                {
                                                                    rotate: [-10, 0, 0],
                                                            ...
                                                            <
                                                            ZoomableGroup zoom = { controlMapPosition.zoom }
                                                            ...
                                                            /ComposableMap> {
                                                                (samplesQty > 0 && dimensions.width > desktop) && ( <
                                                                    div className = "map-upper-right-buttons" > { renderMapLegend() } <
                                                                    /div>
                                                                )
                                                            } {
                                                                (samplesQty > 0) && ( <
                                                                    ...
                                                                    style = {
                                                                        { width: dimensions.width > desktop ? 200 : "-webkit-fill-available" } } >
                                                                    <
                                                                    span style = {
                                                                        { fontWeight: 600, fontSize: 20, marginBottom: dimensions.width > desktop ? 20 : 10 } } > Filters < /span> <
                                                                    div style = {
                                                                        { marginBottom: dimensions.width > desktop ? 16 : 8 } } >
                                                                    <
                                                                    Typography style = {
                                                                        { fontWeight: 500, fontFamily: "Montserrat", color: "rgb(117,117,117)", fontSize: 12 } } >
                                                                    Select dataset <
                                                                    /Typography> <
                                                                    ToggleButtonGroup value = { dataset }
                                                                    ...
                                                                    /Typography> <
                                                                    CustomSlider style = {
                                                                        { marginTop: dimensions.width > desktop ? '' : -5, marginBottom: dimensions.width > desktop ? '' : -5 } }
                                                            ...
                                                            <
                                                            TooltipMaterialUI title = { < span style = {
                                                                    { fontFamily: "Montserrat" } } > Recenter Map < /span>} placement="right"> <
                                                                div
                                                                className = "button"
                                                                onClick = {
                                                                    () => setControlMapPosition({ coordinates: [0, 0], zoom: 1 }) } >
                                                                ...
                                                                /Zoom> <
                                                                TooltipMaterialUI title = { < span style = {
                                                                        { fontFamily: "Montserrat" } } > Zoom In < /span>} placement="right"> <
                                                                    div
                                                                    className = "button"
                                                                    onClick = {
                                                                        () => {
                                                                    ...
                                                                    /TooltipMaterialUI> <
                                                                    TooltipMaterialUI title = { < span style = {
                                                                            { fontFamily: "Montserrat" } } > Zoom Out < /span>} placement="right"> <
                                                                        div
                                                                        className = "button"
                                                                        onClick = {
                                                                            () => {
                                                                        ...
                                                                        <
                                                                        TooltipMaterialUI title = { < span style = {
                                                                                { fontFamily: "Montserrat" } } > Download Map as PNG < /span>} placement="left"> <
                                                                            div
                                                                            ...
                                                                            /TooltipMaterialUI> {
                                                                                captureControlMapInProgress && ( <
                                                                                    CustomCircularProgress size = { 54 }
                                                                                    thickness = { 4 }
                                                                                    style = {
                                                                            ...
                                                                            /div> {
                                                                                (samplesQty > 0 && !dimensions.width > desktop) && ( <
                                                                                    div style = {
                                                                                        { marginTop: 16, marginBottom: 8 } } > { renderMapLegend() } <
                                                                                    /div>
                                                                                )
                                                                            } <
                                                                            ReactTooltip > {
                                                                                                ...
                                                                                                tooltipContent.genotypeInfo.map((genotype, index) => {
                                                                                                    if (index < 5) {
                                                                                                        return ( <
                                                                                                            ...
                                                                                                            div className = "color"
                                                                                                            style = {
                                                                                                                { backgroundColor: getColorForGenotype(genotype.lineage) } }
                                                                                                            /> <
                                                                                                ...
                                                                                                tooltipContent.drugsInfo.map((drug, index) => {
                                                                                                    if (index < 5) {
                                                                                                        return ( <
                                                                                                            ...
                                                                                                            div className = "color"
                                                                                                            style = {
                                                                                                                { backgroundColor: getColorForDrug(drug.name) } }
                                                                                                            /> <
                                                                                                ...
                                                                                                tooltipContent.amrProfilesInfo.map((amr, index) => {
                                                                                                    if (index < 5) {
                                                                                                        return ( <
                                                                                                            ...
                                                                                                            div className = "color"
                                                                                                            style = {
                                                                                                                { backgroundColor: getColorForAMR(amr.name) } }
                                                                                                            /> <
                                                                                                ...
                                                                                                tooltipContent.incTypesInfo.map((incType, index) => {
                                                                                                    if (index < 5) {
                                                                                                        return ( <
                                                                                                            ...
                                                                                                            div className = "color"
                                                                                                            style = {
                                                                                                                { backgroundColor: getColorForIncType(incType.type) } }
                                                                                                            /> <
                                                                            ...
                                                                            <
                                                                            h2 style = {
                                                                                { textAlign: "center" } } > Now showing: { dataset === "full" ? "All" : dataset === "global" ? "Local" : "Travel" }
                                                                            data from { actualCountry === "All" ? "all countries" : actualCountry }
                                                                            from { actualTimePeriodRange.toString().substring(0, 4) }
                                                                            to { actualTimePeriodRange.toString().substring(5) } < /h2> <
                                                                            FormControl fullWidth className = { classes.formControlSelect }
                                                                            style = {
                                                                                { marginBottom: 16, alignItems: "center", textAlign: "center" } } >
                                                                            <
                                                                            label style = {
                                                                                { fontWeight: 500, fontFamily: "Montserrat", whiteSpace: "nowrap", fontSize: 18 } } > Select country(or click map) < /label> <
                                                                            Select
                                                                            value = { actualCountry }
                                                                            onChange = { evt => setActualCountry(evt.target.value) }
                                                                            fullWidth
                                                                            style = {
                                                                                { fontWeight: 600, fontFamily: "Montserrat", width: 200, textAlign: "left" } } >
                                                                            {
                                                                            ...
                                                                            <
                                                                            div style = {
                                                                                { display: "flex", flexDirection: dimensions.width > desktop ? "row" : "column", marginTop: 16, paddingBottom: 20 } } >
                                                                            <
                                                                            div style = {
                                                                                { display: "flex", flexDirection: "column", flex: 0.5, paddingRight: dimensions.width < mobile ? 0 : 10 } } >
                                                                            <
                                                                            div id = "RFWG"
                                                                            style = {
                                                                                { height: 458, width: "100%", display: "flex", flexDirection: "column" } } >
                                                                            <
                                                                            div style = {
                                                                                { width: "100%", flexDirection: "row", textAlign: "center", display: "flex", justifyContent: "center" } } >
                                                                            <
                                                                            span style = {
                                                                                { paddingRight: 32, marginRight: -22 } }
                                                                            className = "chart-title" > Resistance frequencies within genotypes < /span> <
                                                                            div style = {
                                                                                { display: "inline-block", position: "relative" } } >
                                                                            <
                                                                            TooltipMaterialUI title = { < span style = {
                                                                                    { fontFamily: "Montserrat" } } > Download Chart as PNG < /span>} placement="right"> <
                                                                                div
                                                                                style = {
                                                                                    { marginTop: "0", height: "33px", width: "33px" } }
                                                                                ...
                                                                                /TooltipMaterialUI> {
                                                                                    captureControlChartRFWGInProgress && ( <
                                                                                        CustomCircularProgress size = { 44 }
                                                                                        thickness = { 4 }
                                                                                        style = {
                                                                                ...
                                                                                style = {
                                                                                    { marginRight: -22, marginBottom: -8, marginTop: dimensions.width > desktop ? 5 : 10, fontSize: 10, fontWeight: 400 } } > Top Five Genotypes < /span> <
                                                                                div style = {
                                                                                    { height: 420, display: "flex", flexDirection: "row", alignItems: "center" } } >
                                                                                <
                                                                                span className = "y-axis-label-vertical"
                                                                                style = {
                                                                                    { paddingRight: 8, marginBottom: dimensions.width > desktop ? 84 : 154 } } > Number of occurrences < /span> { plotDrugsAndGenotypesChart() } <
                                                                                /div> <
                                                                                /div> <
                                                                                div id = "RFWAG"
                                                                                style = {
                                                                                    { width: "100%", display: "flex", flexDirection: "column", paddingTop: 50 } } >
                                                                                <
                                                                                div style = {
                                                                                    { width: "100%", flexDirection: "row", textAlign: "center", display: "flex", justifyContent: "center" } } >
                                                                                <
                                                                                span className = "chart-title"
                                                                                style = {
                                                                                    { marginRight: -22, paddingRight: 32 } } > Resistance determinants within all genotypes < /span> <
                                                                                div style = {
                                                                                    { display: "inline-block", position: "relative" } } >
                                                                                <
                                                                                TooltipMaterialUI title = { < span style = {
                                                                                    ...
                                                                                    span className = "chart-title"
                                                                                    style = {
                                                                                        { fontSize: 10, fontWeight: 400, paddingBottom: 10, marginTop: dimensions.width > desktop ? 5 : 10 } } > Top Ten Genotypes < /span> <
                                                                                    div style = {
                                                                                        { width: dimensions.width > desktop ? "60%" : "90%", alignSelf: "center", marginBottom: -4, marginRight: dimensions.width > desktop ? "-10%" : 0 } } >
                                                                                    <
                                                                                    FormControl fullWidth className = { classes.formControlSelect }
                                                                                    style = {
                                                                                        { marginTop: 0 } } >
                                                                                    <
                                                                                    InputLabel style = {
                                                                                        { fontWeight: 500, fontFamily: "Montserrat" } } > Select Drug Class < /InputLabel> <
                                                                                    Select
                                                                                    ...
                                                                                    /div> <
                                                                                    div style = {
                                                                                        { height: 350, display: "flex", flexDirection: "row", alignItems: "center" } } >
                                                                                    <
                                                                                    span className = "y-axis-label-vertical"
                                                                                    style = {
                                                                                        { paddingRight: 8 } } > Number of occurrences < /span> { plotAmrClassChart() } <
                                                                                    /div> <
                                                                                    /div> <
                                                                                    /div> <
                                                                                    div style = {
                                                                                        { display: "flex", flexDirection: "column", flex: 0.5, paddingLeft: dimensions.width < mobile ? 0 : 10, marginTop: dimensions.width < mobile ? 25 : 0 } } >
                                                                                    <
                                                                                    div id = "DRT"
                                                                                    style = {
                                                                                        { width: "100%", display: "flex", flexDirection: "column", marginTop: dimensions.width < desktop ? 47 : dimensions.width < 930 ? 18 : 8 } } >
                                                                                    <
                                                                                    div style = {
                                                                                        { width: "100%", flexDirection: "row", textAlign: "center", display: "flex", justifyContent: "center" } } >
                                                                                    <
                                                                                    span className = "chart-title"
                                                                                    style = {
                                                                                        { paddingRight: 32 } } > Drug resistance trends < /span> <
                                                                                    div style = {
                                                                                        { display: "inline-block", position: "relative" } } >
                                                                                    <
                                                                                    TooltipMaterialUI title = { < span style = {
                                                                                        ...
                                                                                        /div> <
                                                                                        div style = {
                                                                                            { height: 422, display: "flex", flexDirection: "row", alignItems: "center" } } >
                                                                                        <
                                                                                        span className = "y-axis-label-vertical"
                                                                                        style = {
                                                                                            { paddingBottom: dimensions.width > desktop ? 84 : 124 } } > Number of occurrences < /span> { plotDrugTrendsChart() } <
                                                                                        /div> <
                                                                                        /div> <
                                                                                        div id = "GD"
                                                                                        style = {
                                                                                            { width: "100%", display: "flex", flexDirection: "column", paddingTop: dimensions.width < mobile ? 30 : dimensions.width < 931 ? 49 : dimensions.width < 1018 ? 60 : 48 } } >
                                                                                        <
                                                                                        div style = {
                                                                                            { width: "100%", flexDirection: "row", textAlign: "center", display: "flex", justifyContent: "center" } } >
                                                                                        <
                                                                                        span className = "chart-title"
                                                                                        style = {
                                                                                            { marginRight: -22, paddingRight: 32 } } > Genotype distribution < /span> <
                                                                                        div style = {
                                                                                            { display: "inline-block", position: "relative" } } >
                                                                                        <
                                                                                        TooltipMaterialUI title = { < span style = {
                                                                                            ...
                                                                                            /div> <
                                                                                            div style = {
                                                                                                { width: dimensions.width > desktop ? "60%" : "90%", alignSelf: "center", paddingRight: dimensions.width > desktop && populationStructureFilter !== 1 ? "-10%" : 0, paddingBottom: populationStructureFilter === 1 ? -8 : 16 } } >
                                                                                            <
                                                                                            FormControl fullWidth className = { classes.formControlSelect }
                                                                                            style = {
                                                                                                { marginBottom: 5, marginTop: 23 } } >
                                                                                            <
                                                                                            InputLabel style = {
                                                                                                { fontWeight: 500, fontFamily: "Montserrat" } } > Population Structure < /InputLabel> <
                                                                                            Select
                                                                                            ...
                                                                                            /div> <
                                                                                            div style = {
                                                                                                { width: '100%', height: 350, display: "flex", flexDirection: populationStructureFilter === 1 ? "row" : "column-reverse", alignItems: "center", paddingLeft: populationStructureFilter === 2 ? -22 : 0 } } > { getPopulationStructureChartLabel() } { plotPopulationStructureChart() } <
                                                                                            /div> <
                                                                                            /div> <
                                                                                            /div> <
                                                                                            /div> <
                                                                                            div style = {
                                                                                                { display: "flex", flexDirection: dimensions.width > desktop ? "row" : "column", padding: 12, alignItems: "center", width: "-webkit-fill-available", justifyContent: "center" } } >
                                                                                            <
                                                                                            div className = "download-sheet-button"
                                                                                            onClick = {
                                                                                                () => dowloadBaseSpreadsheet() } >
                                                                                            <
                                                                                            ...
                                                                                            <
                                                                                            h2 style = {
                                                                                                { marginBottom: 0 } } > About TyphiNET < /h2> <
                                                                                            p >
                                                                                            TyphiNET is a multi - institutional global collaborative network.Our goal is to facilitate data sharing,
                                                                                            and assist in removing barriers to the re - use of pathogen genomic data from both endemic surveillance projects,
                                                                                            as well as those data routinely generated by public health reference laboratories,
                                                                                            for global public health benefit. <
                                                                                            /p> <
                                                                                            p >
                                                                                            The TyphiNET online platform is designed to collate all available whole genome sequence(WGS) data from the bacterial pathogen Salmonella Typhi.As bacterial WGS data is uniquely enriched with many characteristics of the infecting pathogen,
                                                                                            we aim to provide up to date global estimates of both antimicrobial resistance and circulating genotypes
                                                                                            for S.Typhi.We aim to improve global typhoid fever surveillance in the short term,
                                                                                            and to provide evidence to assist in the improvement of intervention strategies and treatment guidelines
                                                                                            for this pathogen in the long term. <
                                                                                            /p> <
                                                                                            p >
                                                                                            TyphiNET is coordinated by Dr Zoe Dyson,
                                                                                            Dr Louise Cerdeira and Prof Kat Holt.We are based at the Department of Infection Biology at the < a href = "https://www.lshtm.ac.uk/"
                                                                                            target = "_blank"
                                                                                            rel = "noreferrer" > London School of Hygiene and Tropical Medicine < /a>, as well as the Department of Infectious Diseases at <a href="https:/ / www.monash.edu / medicine / ccs / infectious - diseases / home " target="
                                                                                            _blank " rel="
                                                                                            noreferrer ">Monash University</a>. For more information about Holt lab projects and members, please visit the <a href="
                                                                                            https: //holtlab.net/" target="_blank" rel="noreferrer">Holt Lab website</a>.
                                                                                                <
                                                                                                /p> <
                                                                                                p >
                                                                                                ...
                                                                                                /p> <
                                                                                                h2 style = {
                                                                                                    { marginBottom: 0 } } > Genomic analysis framework: < /h2> <
                                                                                                p >
                                                                                                TyphiNET utilises the < a href = "https://github.com/katholt/genotyphi/"
                                                                                            target = "_blank"
                                                                                            rel = "noreferrer" > GenoTyphi < /a> genotyping scheme, publised by <a href="https:/ / www.nature.com / articles / ncomms12827 " target="
                                                                                            _blank " rel="
                                                                                            noreferrer ">Wong <i>et al.</i> 2016</a>, and discussed in this <a href="
                                                                                            https: //holtlab.net/2016/10/12/global-picture-typhoid/" target="_blank" rel="noreferrer">blog post</a>.  Data are sourced monthly from the <a href="https://pathogen.watch/" target="_blank" rel="noreferrer">Pathogenwatch</a> online data analysis platform described in this <a href="https://www.biorxiv.org/content/10.1101/2020.07.03.186692v1.abstract" target="_blank" rel="noreferrer">preprint</a> by Argimón <i>et al.</i> 2020.
                                                                                                <
                                                                                                /p> <
                                                                                                /div> <
                                                                                            ...
                                                                                            <
                                                                                            span > Data obtained from: < a href = "https://pathogen.watch"
                                                                                            rel = "noreferrer"
                                                                                            target = "_blank" > pathogen watch project < /a> on 07/
                                                                                            02 / 2021. < a href = "https://holtlab.net"
                                                                                            rel = "noreferrer"
                                                                                            target = "_blank" > Holt Lab < /a></span >
                                                                                            <
                                                                                            /div>
                                                                                            ...
                                                                                            customStyles = {
                                                                                                { padding: 0, overflow: "hidden", width: dimensions.width > desktop ? "75%" : "95%", height: dimensions.width > desktop ? "75%" : "95%" } }
                                                                                            onClose = {
                                                                                                () => {
                                                                                            ...
                                                                                            <
                                                                                            div style = {
                                                                                                { backgroundColor: "transparent", height: "100%", width: "100%", overflow: "hidden" } } >
                                                                                            <
                                                                                            div style = {
                                                                                            ...
                                                                                            style = {
                                                                                                { position: "absolute", right: 24, top: 24, height: 24, width: 24, zIndex: 500 } }
                                                                                            onClick = {
                                                                                                () => {
                                                                                                    setContactModalVisible(false);
                                                                                                }
                                                                                            ...
                                                                                            style = {
                                                                                                { marginRight: 8, color: "black", fontSize: 24 } }
                                                                                            /> <
                                                                                            /div> <
                                                                                            div style = {
                                                                                                {
                                                                                            ...
                                                                                            <
                                                                                            span style = {
                                                                                                { fontWeight: 600, fontSize: 20, marginBottom: 20 } } > Contact < /span> <
                                                                                            ContactPage / >
                                                                                            <
                                                                                            /div> <
                                                                                            /div> <
